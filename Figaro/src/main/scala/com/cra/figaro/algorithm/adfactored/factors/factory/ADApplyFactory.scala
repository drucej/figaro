...
/**
  * Modifications from regular ApplyFactory:
  *  - changed output to Factor[Double, Double]
  *  - changed SparseFactor construction to use DualSemiRing
  *  - setting all dual bits to 0
  */
object ADApplyFactory {
  /**
    * Factor constructor for an Apply Element that has one input
    */
  def makeFactors[T, U](cc: ComponentCollection, apply: Apply1[T, U])(implicit mapper: PointMapper[U]): List[Factor[(Double, Double)]] = {
    ...
    val factor = new SparseFactor[(Double, Double)](List(arg1Var), List(resultVar), SumProductDualSemiring())
  ...
  /**
    ...
    */
  def makeFactors[T1, T2, U](cc: ComponentCollection, apply: Apply2[T1, T2, U])(implicit mapper: PointMapper[U]): List[Factor[(Double, Double)]] = {
    val arg1Var = Factory.getVariable(cc, apply.arg1)
    ...
    val factor = new SparseFactor[(Double, Double)](List(arg1Var, arg2Var), List(resultVar), SumProductDualSemiring())
    val arg1Indices = arg1Var.range.zipWithIndex
    ...
    for {
      ...
      if (arg1Val.isRegular && arg2Val.isRegular) {
        ...
        val resultIndex = resultVar.range.indexWhere(xval => xval.isRegular && xval.value == resultVal)
        factor.set(List(arg1Index, arg2Index, resultIndex), (1.0, 0.0))
      } else {
        throw new IllegalStateException("Cannot handle star")
      }
    }
  ...
  /**
    ...
    */
  def makeFactors[T1, T2, T3, U](cc: ComponentCollection, apply: Apply3[T1, T2, T3, U])(implicit mapper: PointMapper[U]): List[Factor[(Double, Double)]] = {
    val arg1Var = Factory.getVariable(cc, apply.arg1)
    val arg2Var = Factory.getVariable(cc, apply.arg2)
    ...
    val applyMap = applyComponent.getMap
    val applyValues = cc(apply).range
    val factor = new SparseFactor[(Double, Double)](List(arg1Var, arg2Var, arg3Var), List(resultVar), SumProductDualSemiring())
    val arg1Indices = arg1Var.range.zipWithIndex
    val arg2Indices = arg2Var.range.zipWithIndex
    ...
    for {
      ...
      if (arg1Val.isRegular && arg2Val.isRegular && arg3Val.isRegular) {
        ...
        val resultIndex = resultVar.range.indexWhere(xval => xval.isRegular && xval.value == resultVal)
        factor.set(List(arg1Index, arg2Index, arg3Index, resultIndex), (1.0, 0.0))
      } else {
        throw new IllegalStateException("Cannot handle star")
      }
    }
  ...
  /**
    ...
    */
  def makeFactors[T1, T2, T3, T4, U](cc: ComponentCollection, apply: Apply4[T1, T2, T3, T4, U])(implicit mapper: PointMapper[U]): List[Factor[(Double, Double)]] = {
    val arg1Var = Factory.getVariable(cc, apply.arg1)
    val arg2Var = Factory.getVariable(cc, apply.arg2)
    val arg3Var = Factory.getVariable(cc, apply.arg3)
    ...
    val applyMap = applyComponent.getMap
    val applyValues = cc(apply).range
    val factor = new SparseFactor[(Double, Double)](List(arg1Var, arg2Var, arg3Var, arg4Var), List(resultVar), SumProductDualSemiring())
    val arg1Indices = arg1Var.range.zipWithIndex
    val arg2Indices = arg2Var.range.zipWithIndex
    val arg3Indices = arg3Var.range.zipWithIndex
    ...
    for {
      ...
      if (arg1Val.isRegular && arg2Val.isRegular && arg3Val.isRegular && arg4Val.isRegular) {
        ...
        val resultIndex = resultVar.range.indexWhere(xval => xval.isRegular && xval.value == resultVal)
        factor.set(List(arg1Index, arg2Index, arg3Index, arg4Index, resultIndex), (1.0, 0.0))
      } else {
        throw new IllegalStateException("Cannot handle star")
      }
    }
  ...
  /**
    ...
    */
  def makeFactors[T1, T2, T3, T4, T5, U](cc: ComponentCollection, apply: Apply5[T1, T2, T3, T4, T5, U])(implicit mapper: PointMapper[U]): List[Factor[(Double, Double)]] = {
    val arg1Var = Factory.getVariable(cc, apply.arg1)
    val arg2Var = Factory.getVariable(cc, apply.arg2)
    val arg3Var = Factory.getVariable(cc, apply.arg3)
    val arg4Var = Factory.getVariable(cc, apply.arg4)
    ...
    val applyMap = applyComponent.getMap
    val applyValues = cc(apply).range
    val factor = new SparseFactor[(Double, Double)](List(arg1Var, arg2Var, arg3Var, arg4Var, arg5Var), List(resultVar), SumProductDualSemiring())
    val arg1Indices = arg1Var.range.zipWithIndex
    val arg2Indices = arg2Var.range.zipWithIndex
    val arg3Indices = arg3Var.range.zipWithIndex
    val arg4Indices = arg4Var.range.zipWithIndex
    ...
    for {
      ...
      if (arg1Val.isRegular && arg2Val.isRegular && arg3Val.isRegular && arg4Val.isRegular && arg5Val.isRegular) {
        ...
        val resultIndex = resultVar.range.indexWhere(xval => xval.isRegular && xval.value == resultVal)
        factor.set(List(arg1Index, arg2Index, arg3Index, arg4Index, arg5Index, resultIndex), (1.0, 0.0))
      } else {
        throw new IllegalStateException("Cannot handle star")
      }
    }
